 ...
 */
public class ADTListTestProgram {
    public static void main(String[] args) {
        ...
        /* Test #20
         * Test the ADTGroceryList(String[] listItems) constructor overload by creating
         * an array of 20 food item names, then passing this array to
         * the ADTGroceryList(String[] listItems) constructor.  After this test, the
